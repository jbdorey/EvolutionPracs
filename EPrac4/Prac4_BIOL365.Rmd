---
title: "BIOL365 prac 4 — Macroevolutionary questions!"
author: Dr James B Dorey and Dr Damien Esquerré, University of Wollongong
date: "Version `r format(Sys.time(), '%Y-%m-%d')`; practical 2024-08-16"
output: 
  pdf_document:
    toc: true
    toc_depth: 2
...
RootPath <- "/Users/jamesdorey/Desktop/Uni/Teaching/BIOL365_971/BIOL365_pracs_2024/EPrac4"
setwd(RootPath)
```
...
![](Media_EP4_BIOL365/readxl.png){width="100px"}
...
Let us start off about where we were yesterday by loading in the genetic alignment that we saved last week. If you didn't save it, then it will be available on the **Moodle** site for this prac.
...
![](Media_EP4_BIOL365/normalMeme.jpeg){height="250px"}
...
![Figures 5 and 7 from Felenstein, 1985 showing a hypothetical phylogeny and how the traits of those taxa might, through shared ancestry and nonindependence, bias a regular regression analysis.](Media_EP4_BIOL365/Felsenstein1985_plots.png)
...
```{r plotRegularRegression, eval = demonstratorVersion}
  # Like I mentioned, the linear model is jsut a line; so we can also plot that line!
plot(finchSummary$medianBH, finchSummary$log_rangeBH)
...
Listen, I've given you a lot to think about here. I'd be very pleased if you've come this far in our prac. What follows is also a very useful tool in macroevolutionary analyses. I'd encourage you to at least have a look at the outputs and try to make it through the *continuous variables* part. *Categorical variables* get a little more complicated.
...
![](Media_EP4_BIOL365/phytools.png){width="100px"}
...
> **Q5:** Is it more likely that the common ancestor of *Camarhynchus pallidus* and *Geospiza scandens* had a large or a small beak?
...
> **Q6** How would you change the colour of the categories in your phylogeny?
...
![](Media_EP4_BIOL365/readxl.png){width="200px"} ![](Media_EP4_BIOL365/phytools.png){width="200px"} And **corHMM** :/
