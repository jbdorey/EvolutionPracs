...
**Warning:** Last year there was an issue with downloading too many sequences at once through R. This year I have formalised a fix for this issue ([see here for more info](https://jbdorey.github.io/EvolutionPracs/articles/PhyloPrac5.html#read-genbank-error)). If you're having trouble downloading say >300 sequences in one go, try the below code! 

```{r genbankMassRead, eval = TRUE, show = TRUE}
