...
date: "Version `r format(Sys.time(), '%Y-%m-%d')`; practical 2026-08-14"
output: 
...
#| include: FALSE
knitr::opts_chunk$set(collapse = TRUE, comment = "#>", echo = TRUE, message=FALSE)
...
Last year, a few people had trouble displaying their alignment using **msaR**. If this is you, you might still be able to "Export" your alignment as an interactive `.html` file using the "Viewer" window in RStudio. Go `Export` > `Save as Web Page`.

</div>

```{r downloadmsaRData, include=FALSE}
...
**Attention:**
By the end of Week 4 (next week), I want you to have the data that you mentioned in Question 11; prac 2. You will need to show this to your demonstrator. I have re-phrased this below:
