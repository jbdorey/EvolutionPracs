...
```{r sneakydata, eval = TRUE, include = FALSE}
gc()
devtools::load_all()
path <- system.file("extdata", "morphLack.xls", package = "EvolPracs")
finchData <- readxl::read_excel(path, sheet = "morphLack.TAB", guess_max = 7000)
```

```{r downloadData_morphology, include=TRUE, eval = FALSE}
