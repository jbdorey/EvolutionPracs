...
date: "Version `r format(Sys.time(), '%Y-%m-%d')`; practical 2026-08-21"
output: 
...
```{r installcorHMM, include = TRUE, eval = FALSE}
...
> **Q7** How would you code in a change in the colour of the categories in your phylogeny?
...
**Attention:**
It is now the end of Week 4 (next week), I want you to have the data that you mentioned in Question 11; prac 2. You will need to show this to your demonstrator. I have re-phrased this below:
...
## Part (a) — preliminary phylogeny (10%)
...
2.  Using trait data from the literature or data extracted from photos for that clade model that trait along the phylogeny (from the above point) and summarise how that trait has changed
    ...
    c.  c.	Provide references to the (i) genbank accession numbers for the sequences (or similar), (ii) the original research articles (or similar) where the data were retrieved or derived, (iii) your code — the latter will help demonstrators help you with your code, and (iv) **ONLY IF you used MEGA for alignments and/or trees**, you must report at least (a) the number of samples/species, (b) the maximum length of the alignment, (c) the alignment algorithm used, (d) the tree model used, (e) the number of bootstraps/repetitions, (f) the substitution model, and (g) anything else unique and important to your analysis.
...
## Part (b) — Project quality and innovation (10%)
