---
title: "BIOL365 Evolutionary Prac 3 — Aligning genetic data and building phylogenies in R"
author: Dr James B Dorey and Dr Damien Esquerré, University of Wollongong
date: "Version `r format(Sys.time(), '%Y-%m-%d')`; practical 2024-08-09"
output: 
  pdf_document:
    toc: true
    toc_depth: 2
...
# Set the RootPath to EPrac3 folder
RootPath <- "/Users/jamesdorey/Desktop/Uni/Teaching/BIOL365_971/BIOL365_pracs_2024/EPrac3"
setwd(RootPath)
...
![](Media_EP3_BIOL365/tidyr.png){width="100px"}
![](Media_EP3_BIOL365/tibble.png){width="100px"}
![](Media_EP3_BIOL365/stringr.png){width="100px"}
...
```{r mySecondSearch,  eval=demonstratorVersion}
...
```{r getSeqLengths,  eval=demonstratorVersion}
...
```{r collateSeqChoiceData,  eval=demonstratorVersion}
...
Great, now we can very quickly look at the data that we downloadeded and make some choices on which sequences that we're going to keep. For simplicity's sake, let's just take the sequence that is longest per species. To do that we will need to sort by sequence length and then choose the top sequence. Who can help us with that? Our good friend **dplyr**.
...
```{r chooseSequences,  eval=demonstratorVersion}
...
```{r filterDNAbin,  eval=demonstratorVersion}
...
library(msa)
```
![](Media_EP3_BIOL365/BiocManager.png){width="100px"}
![](Media_EP3_BIOL365/msaR.png){width="100px"}
![](Media_EP3_BIOL365/Biostrings.png){width="100px"}
![](Media_EP3_BIOL365/msa.png){width="100px"}

 \

```{r visualiseSeqs, eval = demonstratorVersion}
...
```{r alignment,  eval=demonstratorVersion}
...
![](Media_EP3_BIOL365/phangorn.png){width="100px"}
...
![](Media_EP3_BIOL365/tidyr.png){width="200px"}
![](Media_EP3_BIOL365/tibble.png){width="200px"}
![](Media_EP3_BIOL365/stringr.png){width="200px"}
![](Media_EP3_BIOL365/BiocManager.png){width="200px"}
![](Media_EP3_BIOL365/msaR.png){width="200px"}
![](Media_EP3_BIOL365/Biostrings.png){width="200px"}
![](Media_EP3_BIOL365/msa.png){width="200px"}
![](Media_EP3_BIOL365/phangorn.png){width="200px"}
